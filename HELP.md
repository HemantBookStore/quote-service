...
* The original package name 'com.polarbookshop.quote-service' is invalid and this project uses 'com.polarbookshop.quoteservice' instead.
...
```
$ docker run --rm -p 8080:8080 quote-service:0.0.1-SNAPSHOT
```
